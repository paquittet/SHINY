...
$a(x_i, x_j) = e^{-\frac{1}{2}(x_i - x_j)^2/\sigma_a ^2}$
...
x = seq(0.01, 1.99, 0.004)
y = seq(0.01, 1.99, 0.004)



# Activation ou non des PIP

  

  renderPlot({
  if(input$activation_pip == "Oui"){
...
filled.contour.modif(
                    ...
                    y = y,
                    z = z,
                    col = c(adjustcolor("white", alpha.f = 0), adjustcolor("#ffdf7f", alpha.f = 1)),
                    xlab = NULL,
                    ylab = NULL,
                    xlim = c(0, 2),
                    ylim = c(0, 2),
...
filled.contour.modif(
                    ...
                    y = y,
                    z = z_rev,
                    col = c(adjustcolor("white", alpha.f = 0), adjustcolor("#a6cde9", alpha.f = 1)),
                    xlab = NULL,
                    ylab = NULL,
                    xlim = c(0, 2),
                    ylim = c(0, 2),
