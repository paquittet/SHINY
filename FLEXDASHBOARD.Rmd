...
$$\small \frac{\partial^2_s(x, y)}{\partial_{y^2}}\Big|_{y=x= \color{red}{x_0}}$$ 

$\color{blue}{\text{Stabilité de convergence}}$ (`r convergence_text` `r reactive({if(convergence_text() == "Stable"){paste("< 0")}else{paste("> 0")}})`)      
$$\small \frac{\partial^2_s(x, y)}{\partial_{x} \partial_{y}} + \frac{\partial^2_s(x, y)}{\partial_{y^2}}\Big|_{y=x=\color{red}{x_0}}$$ 
...
points(x = 1, y = 1, col = "red")
 ...
 # Paramètre graphique
  par(
    ...
    cex.lab = 1.2,
    mar = c(12, 7, 0, 5), # marges intérieures (bas, gauche, haut, droite)
    oma = c(8, 0, 0, 0), # marges extérieures
