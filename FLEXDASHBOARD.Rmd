...
actionButton(inputId = "pip", label = "PIP")
...
**Stabilité évolutive et convergence du point $x_0$ **  

- **Stabilité évolutive** : `r ess_text` 
- **Convergence évolutive** : `r convergence_text` 
...
y = seq(0.01, 1.99, 0.02)
  ...
  # Paramètre graphique
  par(
    mar = c(8, 4, 0, 2), # marges intérieures
...
# NOMBRE DE PHENOTYPES
                numericInput(inputId = "N", label = "Nombre de phénotypes", value = 2, min = 2, max = 50)
#  FONCTION K 
                 # Widget_slider : K_0
                 sliderInput(
                   inputId = "k0_n",
...
# Bouton de reset aux valeurs inititales
actionButton(inputId = "reset_n", label = "Reset")
observe({input$reset
